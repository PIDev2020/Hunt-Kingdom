...
//                int season_id = (int)Float.parseFloat(obj.get("season_id").toString());
    ...
    public void updateAnimal(Animal animals){
        ...
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/HuntKingdom/web/app_dev.php/updateanimalapi?idA=" + animals.getIdA() + "&race=" + animals.getRace() + "&saison=" + animals.getSaison() + "&place=" + animals.getPlace() + "&image=" + animals.getImage() + "&hunted=" + animals.getHunted();
        con.setUrl(Url);
