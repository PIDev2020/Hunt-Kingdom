...
//                Date datef=new SimpleDateFormat("dd/MM/yyyy").parse(finish);
    ...
    public void supprimerSeason(int id){
        ...
        String Url = "http://localhost/HuntKingdom/web/app_dev.php/deleteSeason/"+id;
        con.setUrl(Url);
    ...
    public void updateSeason(Season s){
        ...
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/HuntKingdom/web/app_dev.php/updateseason?id=" + s.getId() + "&nom=" + s.getNom() + "&start=" + s.getStart() + "&finish=" + s.getFinish() + "&description=" + s.getDescription();
        con.setUrl(Url);
