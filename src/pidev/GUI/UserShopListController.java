...
public class UserShopListController implements Initializable {
    ...
    private void addcart(ActionEvent event) throws IOException, SQLException {
        ...
        sc.ajouterpanier(new Commande(name.getCellData(Table.getSelectionModel().getSelectedIndex()),price.getCellData(Table.getSelectionModel().getSelectedIndex()),1,0));
